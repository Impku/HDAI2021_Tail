...
def main():
    args = ParserArguments(ptype="A2C")
    ...
    A2C_img,A2C_mask,A2C_label,A2C_orig,A2C_position = load_dataset(datapath=args.data_root,trainer=trainer1,args=args)


    for n,(img,mask,name,orig,position) in enumerate(tqdm(zip(A2C_img,A2C_mask,A2C_label,A2C_orig,A2C_position))):
    ...
    mean_dice, mean_jaccard= compute_mean(json_dict, option='A2C')
